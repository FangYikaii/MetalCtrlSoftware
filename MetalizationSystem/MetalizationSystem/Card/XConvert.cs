...
namespace MetalizationSystem
{
    ...
    {
        #region PULS<->MM
        public static float MM2PULS(double MM, double lead,int pulsesPre=10000)
        {
            return (float)(MM * pulsesPre / lead);
        }
        public static float PULS2MM(int PULS, double lead, int pulsesPre = 10000)
        {
            return (float)(PULS * lead / pulsesPre);
        }
        #endregion
