...
{
    [Serializable]
    public class Process_CoatingPostImmersion : NodeModel
    {
        public override string Key { get; set; }
        public override string Station { get; set; } = "膜后浸";
        public override string Name { get; set; } = "膜后浸";
        public override int TaskId { get; set; } = (int)EnumInfo.TaskId.CoatingPostImmersion;
        public override string Tag { get; set; } = "Process_CoatingPostImmersion";
