...
{
    [Serializable]
    public class Process_GlassAcidPickling : NodeModel
    {
        public override string Key { get; set; }
        public override string Station { get; set; } = "玻璃酸洗";
        public override string Name { get; set; } = "玻璃酸洗";
        public override int TaskId { get; set; } = (int)EnumInfo.TaskId.GlassAcidPickling;
        public override string Tag { get; set; } = "Process_GlassAcidPickling";
