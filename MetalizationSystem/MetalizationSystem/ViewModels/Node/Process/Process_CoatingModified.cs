...
{
    [Serializable]
    public class Process_CoatingModified : NodeModel
    {
        public override string Key { get; set; }
        public override string Station { get; set; } = "膜改性";
        public override string Name { get; set; } = "膜改性";
        public override int TaskId { get; set; } = (int)EnumInfo.TaskId.CoatingModified;
        public override string Tag { get; set; } = "Process_CoatingModified";
