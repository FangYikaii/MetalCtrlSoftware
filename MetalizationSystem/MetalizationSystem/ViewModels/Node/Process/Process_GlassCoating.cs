...
{
    [Serializable]
    public class Process_GlassCoating : NodeModel
    {
        public override string Key { get; set; }
        public override string Station { get; set; } = "玻璃镀膜";
        public override string Name { get; set; } = "玻璃镀膜";
        public override int TaskId { get; set; } = (int)EnumInfo.TaskId.GlassCoating;
        public override string Tag { get; set; } = "Process_GlassCoating";
