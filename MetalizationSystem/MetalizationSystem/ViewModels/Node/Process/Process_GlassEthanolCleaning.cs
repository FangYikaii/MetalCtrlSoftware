...
{
    [Serializable]
    public class Process_GlassEthanolCleaning : NodeModel
    {
        public override string Key { get; set; }
        public override string Station { get; set; } = "乙醇清洗";
        public override string Name { get; set; } = "乙醇清洗";
        public override int TaskId { get; set; } = (int)EnumInfo.TaskId.GlassEthanolCleaning;
        public override string Tag { get; set; } = "Process_GlassEthanolCleaning";
