...
{
    [Serializable]
    public class Process_GlassDegreasing : NodeModel
    {
        public override string Key { get; set; }
        public override string Station { get; set; } = "玻璃除油";
        public override string Name { get; set; } = "玻璃除油";
        public override int TaskId { get; set; } = (int)EnumInfo.TaskId.GlassDegreasing;
        public override string Tag { get; set; } = "Process_GlassDegreasing";
