...
{
    [Serializable]
    public class Process_CoatingPrepreg : NodeModel
    {
        public override string Key { get; set; }
        public override string Station { get; set; } = "膜预浸";
        public override string Name { get; set; } = "膜预浸";
        public override int TaskId { get; set; } = (int)EnumInfo.TaskId.CoatingPrepreg;
        public override string Tag { get; set; } = "Process_CoatingPrepreg";
