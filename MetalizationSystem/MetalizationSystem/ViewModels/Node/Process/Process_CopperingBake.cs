...
{
    [Serializable]
    public class Process_CopperingBake : NodeModel
    {
        public override string Key { get; set; }
        public override string Station { get; set; } = "镀膜烘干";
        public override string Name { get; set; } = "镀膜烘干";
        public override int TaskId { get; set; } = (int)EnumInfo.TaskId.CopperingBake;
        public override string Tag { get; set; } = "Process_CopperingBake";
