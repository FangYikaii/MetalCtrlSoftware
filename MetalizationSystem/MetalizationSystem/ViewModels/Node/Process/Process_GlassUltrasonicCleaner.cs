...
{
    [Serializable]
    public class Process_GlassUltrasonicCleaner : NodeModel
    {
        public override string Key { get; set; }
        public override string Station { get; set; } = "超声波";
        public override string Name { get; set; } = "超声波";
        public override int TaskId { get; set; } = (int)EnumInfo.TaskId.GlassUltrasonicCleaner;
        public override string Tag { get; set; } = "Process_GlassUltrasonicCleaner";
