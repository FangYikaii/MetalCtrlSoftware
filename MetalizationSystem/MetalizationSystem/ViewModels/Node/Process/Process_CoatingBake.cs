...
namespace MetalizationSystem.ViewModels.Node
{
    ...
    /// </summary>
    [Serializable]
    public class Process_CoatingBake : NodeModel
    {
        public override string Key { get; set; }
        public override string Station { get; set; } = "膜烘干";
        public override int TaskId { get; set; } = (int)EnumInfo.TaskId.CoatingBake;
        public override string Name { get; set; } = "膜烘干";
        public override string Tag { get; set; } = "Process_CoatingBake";
