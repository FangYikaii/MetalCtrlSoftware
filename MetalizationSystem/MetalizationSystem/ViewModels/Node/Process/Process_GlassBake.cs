...
{
    [Serializable]
    public class Process_GlassBake : NodeModel
    {
        public override string Key { get; set; }
        public override string Station { get; set; } = "玻璃烘干";
        public override string Name { get; set; } = "玻璃烘干";
        public override int TaskId { get; set; } = (int)EnumInfo.TaskId.GlassBake;
        public override string Tag { get; set; } = "Process_GlassBake";
