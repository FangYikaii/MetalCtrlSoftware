...
namespace XCore
{
    public abstract class XEventServerBase : XObject
    {
        ...
        public abstract void PostEvent(XEventHandler target, XEventID eventID, XEventArgs eventArgs = null, XObject sender = null, bool isPriority = false);
        ...
        public XEvent CreateEvent(XEventHandler target, XEventID eventID, XEventArgs eventArgs = null, XObject sender = null)
        {
            ...
            {
                xEvent = new XEvent(target, eventID, eventArgs, sender);
            }
            return xEvent;
        }
